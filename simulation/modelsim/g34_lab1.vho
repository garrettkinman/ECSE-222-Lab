...
-- code[1]	=>  Location: PIN_AA30,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- code[2]	=>  Location: PIN_AB28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- code[3]	=>  Location: PIN_AC29,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF g34_7_segment_decoder IS
...
-- Equation(s):
-- \Mux6~0_combout\ = ( \code[3]~input_o\ & ( \code[2]~input_o\ & ( (!\code[1]~input_o\ & \code[0]~input_o\) ) ) ) # ( !\code[3]~input_o\ & ( \code[2]~input_o\ & ( (!\code[1]~input_o\ & !\code[0]~input_o\) ) ) ) # ( \code[3]~input_o\ & ( !\code[2]~input_o\ & 
-- ( (\code[1]~input_o\ & \code[0]~input_o\) ) ) ) # ( !\code[3]~input_o\ & ( !\code[2]~input_o\ & ( (!\code[1]~input_o\ & \code[0]~input_o\) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_code[1]~input_o\,
	datac => \ALT_INV_code[0]~input_o\,
	datae => \ALT_INV_code[3]~input_o\,
...
-- Equation(s):
-- \Mux5~0_combout\ = ( \code[3]~input_o\ & ( \code[2]~input_o\ & ( (!\code[0]~input_o\) # (\code[1]~input_o\) ) ) ) # ( !\code[3]~input_o\ & ( \code[2]~input_o\ & ( !\code[0]~input_o\ $ (!\code[1]~input_o\) ) ) ) # ( \code[3]~input_o\ & ( !\code[2]~input_o\ 
-- & ( (\code[0]~input_o\ & \code[1]~input_o\) ) ) )
...
-- Equation(s):
-- \Mux4~0_combout\ = ( \code[3]~input_o\ & ( \code[2]~input_o\ & ( (!\code[0]~input_o\) # (\code[1]~input_o\) ) ) ) # ( !\code[3]~input_o\ & ( !\code[2]~input_o\ & ( (\code[1]~input_o\ & !\code[0]~input_o\) ) ) )
...
-- Equation(s):
-- \Mux3~0_combout\ = ( \code[3]~input_o\ & ( \code[2]~input_o\ & ( (\code[0]~input_o\ & \code[1]~input_o\) ) ) ) # ( !\code[3]~input_o\ & ( \code[2]~input_o\ & ( !\code[0]~input_o\ $ (\code[1]~input_o\) ) ) ) # ( \code[3]~input_o\ & ( !\code[2]~input_o\ & ( 
-- (!\code[0]~input_o\ & \code[1]~input_o\) ) ) ) # ( !\code[3]~input_o\ & ( !\code[2]~input_o\ & ( (\code[0]~input_o\ & !\code[1]~input_o\) ) ) )
...
-- Equation(s):
-- \Mux2~0_combout\ = ( !\code[3]~input_o\ & ( \code[2]~input_o\ & ( (!\code[1]~input_o\) # (\code[0]~input_o\) ) ) ) # ( \code[3]~input_o\ & ( !\code[2]~input_o\ & ( (!\code[1]~input_o\ & \code[0]~input_o\) ) ) ) # ( !\code[3]~input_o\ & ( 
-- !\code[2]~input_o\ & ( \code[0]~input_o\ ) ) )
...
-- Equation(s):
-- \Mux1~0_combout\ = ( \code[3]~input_o\ & ( \code[2]~input_o\ & ( (\code[0]~input_o\ & !\code[1]~input_o\) ) ) ) # ( !\code[3]~input_o\ & ( \code[2]~input_o\ & ( (\code[0]~input_o\ & \code[1]~input_o\) ) ) ) # ( !\code[3]~input_o\ & ( !\code[2]~input_o\ & 
-- ( (\code[1]~input_o\) # (\code[0]~input_o\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010111111111000000000000000000000000010101010101010100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_code[0]~input_o\,
...
-- Equation(s):
-- \Mux0~0_combout\ = ( \code[3]~input_o\ & ( \code[2]~input_o\ & ( (\code[0]~input_o\) # (\code[1]~input_o\) ) ) ) # ( !\code[3]~input_o\ & ( \code[2]~input_o\ & ( (!\code[1]~input_o\) # (!\code[0]~input_o\) ) ) ) # ( \code[3]~input_o\ & ( 
-- !\code[2]~input_o\ ) ) # ( !\code[3]~input_o\ & ( !\code[2]~input_o\ & ( \code[1]~input_o\ ) ) )
